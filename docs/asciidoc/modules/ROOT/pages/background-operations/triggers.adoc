...
[cols="5m,5"]
|===
| apoc.trigger.nodesByLabel($assignedLabels/$removedLabels,'Label') | function to filter entries by label, to be used within a trigger statement with `$assignedLabels` and `$removedLabels`
